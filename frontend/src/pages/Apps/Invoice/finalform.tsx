...
const FinalForm = () => {
  ...
  const sendDataToBackend = async (data: any) => {
    try {
      ...
      setCaseDescription(data.caseDetails.caseDescription);
      setMainDistrict(data.caseDetails.mainDistrict);
      setEstablishment(data.caseDetails.establishment);
      setNatureOfCase(data.caseDetails.natureOfCase);
      setReliefSought(data.caseDetails.reliefSought);
      setCaseType(data.caseDetails.caseType);
      setPlaintiff(data.caseDetails.plaintiff);
      setContactNumber(Number(data.caseDetails.contactNumber));
      setPetitionerName(data.petitioner.name);
      setPetitionerGender(data.petitioner.gender);
      setPetitionerRelation(data.petitioner.relation);
      setPetitionerDateOfBirth(data.petitioner.dateOfBirth);
      setPetitionerAge(Number(data.petitioner.age));
      setPetitionerCaseDetails(data.petitioner.caseDetails);
      setPetitionerExtraName(data.petitioner.extraName);
      setPetitionerEmail(data.petitioner.email);
      setPetitionerOccupation(data.petitioner.occupation);
      setPetitionerMobileNumber(Number(data.petitioner.mobileNumber)); // Convert to number assuming it's an input type number
      setPetitionerPinCode(Number(data.petitioner.pinCode)); // Convert to number assuming it's an input type number
      setPetitionerAddress(data.petitioner.address);
      setPetitionerState(data.petitioner.state);
      setPetitionerDistrict(data.petitioner.district);
      setPetitionerTaluka(data.petitioner.taluka);
      setPetitionerVillage(data.petitioner.village);
      setResponderName(data.responder.name);
      setResponderGender(data.responder.gender);
      setResponderRelation(data.responder.relation);
      setResponderDateOfBirth(data.responder.dateOfBirth);
      setResponderAge(Number(data.responder.age));
      setResponderCaseDetails(data.responder.caseDetails);
      setResponderExtraName(data.responder.extraName);
      setResponderEmail(data.responder.email);
      setResponderOccupation(data.responder.occupation);
      setResponderMobileNumber(Number(data.responder.MobileNumber));
      setResponderPinCode(Number(data.responder.pinCode));
      setResponderAddress(data.responder.address);
      setResponderState(data.responder.state);
      setResponderDistrict(data.responder.district);
      setResponderTaluka(data.responder.taluka);
      setResponderVillage(data.responder.village);
      setCauseOfAction(data.causeOfAction);
      setCauseOfActionDate(data.causeOfActionDate);
      setImportantInformation(data.importantInformation);
      setPrayer(data.prayer);
      setValuation(Number(data.valuation));
      setLocationState(data.location.state);
      setLocationDistrict(data.location.district);
      setLocationTaluka(data.location.taluka);
      setLocationVillage(data.location.village);
      setLegalAct(data.legalDetails.act);
      setLegalSection(data.legalDetails.section);
    } catch (error: any) {
  ...
  const [user, changeUser] = useState<boolean>();
