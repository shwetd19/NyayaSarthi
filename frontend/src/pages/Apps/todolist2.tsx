...
const MultipleTables = () => {
  ...
  const [recordsData, setRecordsData] = useState<any>(tempData);
  ...
  const fetchData = async () => {
    try {
      ...
      if (response.ok) {
        // econst data: UserData[] = await response.json();
        ...
        <div className="datatables">
          <DataTable
            ...
            columns={[
              ...
              {
                accessor: "DateofCauseofAction",
                title: "Date of Cause of Action",
              },
