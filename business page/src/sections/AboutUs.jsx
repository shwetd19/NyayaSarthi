...
export const AboutUs = () => {
  ...
  return (
    <>
      <div className="m-10 flex flex-col justify-items-center absolute z-20">
      ...
      <div className="w-full relative -z-10">
        <img
          ...
          src={
            'https://images.unsplash.com/photo-1510146758428-e5e4b17b8b6a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
          }
        />
      </div>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="max-w-2xl mx-auto bg-rgb(245 246 255 / var(--tw-bg-opacity)) text-center mb-10 lg:mb-14">
          ...
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="text-2xl font-medium title-font mb-4 text-gray-900 tracking-widest">MEET OUR TEAM</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12 max-w-7xl">
        ...
        <section className="text-gray-600 body-font">
          <div className="container px-5 py-24 mx-auto">
            ...
            <div>
              <div className="flex justify-evenly -m-4 flex-wrap ">
                {/* Team members */}
